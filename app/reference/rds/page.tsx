        ...
        <div className="max-w-6xl mx-auto">
          ...
          {activeTab === 'overview' && (
            ...
            >
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h2 className="text-3xl font-bold text-gray-900 mb-6">What is RDS?</h2>
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">RDS Benefits</h3>
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">RDS Architecture</h3>
          ...
          {activeTab === 'engines' && (
            <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <h2 className="text-3xl font-bold text-gray-900 mb-8">Supported Database Engines</h2>
          ...
          {activeTab === 'security' && (
            <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <h2 className="text-3xl font-bold text-gray-900 mb-8">RDS Security</h2>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div>
                  <div className="bg-white rounded-lg shadow-md p-6 border mb-6">
                    <h3 className="text-xl font-semibold text-gray-900 mb-4">IAM Database Authentication</h3>
                    <p className="text-gray-700 mb-4">
                  ...
                  <div className="bg-white rounded-lg shadow-md p-6 border">
                    <h3 className="text-xl font-semibold text-gray-900 mb-4">Parameter Groups</h3>
                    <p className="text-gray-700 mb-4">
          ...
          {activeTab === 'performance' && (
            <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <h2 className="text-3xl font-bold text-gray-900 mb-8">RDS Performance</h2>
          ...
          {activeTab === 'scenarios' && (
            <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <h2 className="text-3xl font-bold text-gray-900 mb-8">Common RDS Scenarios</h2>
              
              <div className="space-y-8">
                <div className="bg-white rounded-lg shadow-md p-6 border">
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">Scenario 1: High Availability Setup</h3>
                ...
                <div className="bg-white rounded-lg shadow-md p-6 border">
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">Scenario 2: Read Scaling</h3>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <p className="text-gray-700 mb-4">
                    ...
                    <div className="bg-gray-50 p-4 rounded">
                      <h4 className="font-semibold mb-3">Traffic Flow</h4>
                      <div className="space-y-2 text-sm">
                        <div className="flex items-center">
                          <span>Web App</span>
                          <ArrowRight className="w-4 h-4 mx-2" />
          ...
          {activeTab === 'exam-tips' && (
            <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <h2 className="text-3xl font-bold text-gray-900 mb-8">RDS Exam Tips</h2>
